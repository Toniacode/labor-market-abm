...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks (ifelse-value count seekers with[my-company != nobody] > 0 [mean [expected-wage] of seekers with [my-company != nobody]] [0])\n"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot ifelse-value count seekers > 0 [mean [tolerance] of seekers][0]"
...
"" ""
PENS
"Unemployment Rate" 1.0 0 -16777216 true "" "plot ifelse-value count seekers > 0 [count seekers with [my-company = nobody] / count seekers][0]"
"Unfilled Position" 1.0 0 -7500403 true "" "plot ifelse-value count vacancies > 0 [count vacancies with [filled? = false] / (count vacancies + COUNT occupations)][0]"
...
723
UMP-seekers
count seekers with [my-company = nobody or my-company = 0]
17
1
11
...
@#$#@#$#@
<experiments>
  <experiment name="network-comparison" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt; 10 and (count vacancies = 0 or count seekers with [my-company = nobody] = 0 or ticks &gt; 36)</exitCondition>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
    <metric>mean-wages</metric>
    <metric>wage-R</metric>
    <metric>wage-SS</metric>
    <metric>wage-FS</metric>
    <metric>wage-diff-R</metric>
    <metric>wage-diff-SS</metric>
    <metric>wage-diff-FS</metric>
    <metric>success-R</metric>
    <metric>success-SS</metric>
    <metric>success-FS</metric>
    <enumeratedValueSet variable="minimum-wage">
      <value value="500"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="α">
      <value value="0.2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="β">
      <value value="0.5"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="new-UMP?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dynamic-adaption?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-companies">
      <value value="300"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="jobless-rate">
      <value value="0.6"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rewire-probability">
      <value value="0.2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-vacancies">
      <value value="450"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="growth-rate">
      <value value="0.2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="σ">
      <value value="0.55"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ε">
      <value value="0.27"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-tolerance">
      <value value="0.03"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-seekers">
      <value value="1500"/>
    </enumeratedValueSet>
  ...
  <experiment name="sensitive-analysis-jobless-rate" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="sensitive-analysis-β" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
    ...
    <steppedValueSet variable="β" first="0.4" step="0.05" last="0.6"/>
    <enumeratedValueSet variable="network-type">
      <value value="&quot;ER&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="new-UMP?">
  ...
  <experiment name="σ" repetitions="2" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="epsilon" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
    ...
    <steppedValueSet variable="ε" first="0.25" step="0.02" last="0.35"/>
    <enumeratedValueSet variable="initial-tolerance">
      <value value="0.03"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="A">
  ...
  <experiment name="β" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="rewire probability" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="experiment contacts" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="experimentB2" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="σ (copy)" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
  ...
  <experiment name="experimentB3" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>U-rate</metric>
    <metric>V-rate</metric>
